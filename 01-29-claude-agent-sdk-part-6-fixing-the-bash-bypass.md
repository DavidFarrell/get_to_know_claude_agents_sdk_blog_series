...
image: images/02-16-claude-agent-sdk-part-6.png
caption: "TBD"
categories:
  - coding
...
![Permission evaluation flow](images/02-16-permissions-flow.svg)
...
![Bash permission prompt working](images/02-16-bash-permission-prompt.png)
...
![Bash command running without prompt](images/02-16-bash-caching-no-prompt.png)
...
![Hooks working - each Bash command prompts separately](images/02-16-hooks-per-command-working.png)
